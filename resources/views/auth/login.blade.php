<x-guest-layout>
    <!-- Teks di atas form login -->
    <div class="mb-4 text-center">
        <h2 class="text-xl font-semibold">Login Admin BUP Genteng</h2>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <!-- Button Register di sebelah login -->
            @if (Route::has('register'))
            <a href="{{ route('register') }}" class="ms-3 btn btn-outline-primary text-sm">
                {{ __('Buat Akun') }}
            </a>
            @endif
        </div>
